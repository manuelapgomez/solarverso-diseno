            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#4b5563', fontSize: '13px', background: '#f1f5f9', padding: '6px 12px', borderRadius: '8px', fontWeight: '500' }}>
                  ...
                  Arribo: {ship.terminalArribo || 'Pendiente'}
                </div>

                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'var(--brand-primary)', fontSize: '13px', background: 'var(--brand-primary-light-1)', padding: '6px 8px 6px 12px', borderRadius: '8px', fontWeight: '600', position: 'relative' }}>
                  ...
                  Destino: {isFilled ? slot.nombreMgs : "Disponible"}
                  <div 
                    onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                    style={{ display: 'flex', alignItems: 'center', gap: '4px', background: '#ffffff', padding: '4px 8px', borderRadius: '6px', cursor: 'pointer', border: '1px solid #e5e7eb', marginLeft: '4px', color: '#111827', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' }}
                  ...
                  >
                    <span style={{ fontSize: '12px' }}>{isFilled ? "Reasignar" : "Asignar"}</span>
                  ...
                  {isDropdownOpen && (
                    <div style={{ position: 'absolute', top: 'calc(100% + 8px)', right: 0, width: '320px', background: '#ffffff', borderRadius: '8px', boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)', border: '1px solid #e5e7eb', zIndex: 100, textAlign: 'left', overflow: 'hidden' }}>
                            ...
                            validOrphans.map(o => (
                              <div 
                                ...
                                style={{ 
                                  ...
                                  backgroundColor: selectedMgsId === o.id ? 'var(--brand-primary-light-1)' : 'white', 
                                  display: 'flex', 
                                ...
                                onClick={() => { 
                                  setSelectedMgsId(o.id); 
                                  setIsDropdownOpen(false); 
                                  if (slotIndex !== null) onSwap(slotIndex, o.id, o.nombre, equipoAFiltrar || ""); 
                                }}
                                onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#f9fafb'}
                                onMouseLeave={(e) => e.currentTarget.style.backgroundColor = selectedMgsId === o.id ? 'var(--brand-primary-light-1)' : 'white'}
                              >

...
import { mockPortfolios, type SlotCarga, type Barco, type MgsHuerfana, type SpecEquipo } from "../../data/mockLogistica";
    ...
    return barcos.filter(ship => {
      ...
      if (activeReqFilter) {
          reqMatch = ship.slots.some(slot => {
              ...
              if (!slotSpecs) return true; // If we demanded specs, but slot has none attached yet, don't throw it out completely loosely.
